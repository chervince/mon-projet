        ...
        {result.success ? (
              ...
              <div className="space-y-3">
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {result.ticketAmount?.toLocaleString()} XPF
                  </span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="font-semibold">
                    {result.merchant?.creditPercentage}%
                  </span>
                </div>
                ...
                {result.totalCredits !== undefined && (
                  <div className="flex justify-between items-center bg-gray-50 p-3 rounded-lg">
                    <span className="text-gray-600">
                      Total crédits chez ce marchand
                    </span>
                    <span className="font-semibold">
                      {result.totalCredits.toLocaleString()} XPF
                    </span>
                  </div>
                )}
              </div>
              ...
              <div className="bg-gradient-to-r from-yellow-50 to-yellow-100 border border-yellow-200 rounded-2xl p-6">
                <div className="text-center">
                  ...
                  <p className="text-yellow-700 mb-4">
                    Félicitations ! Vous avez atteint le seuil et obtenu un bon
                    de {result.voucherGenerated.amount.toLocaleString()} XPF
                  </p>
          ...
          <div className="space-y-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                {result.error ||
                  "Une erreur est survenue lors du traitement du ticket"}
              </p>
            </div>
